...
def run(protocol: protocol_api.ProtocolContext):
    ...
    # Load labware
    source_plate = protocol.load_labware('nest_96_wellplate_100ul_pcr_full_skirt', 'D1', 'Source Plate')
    dest_plate = protocol.load_labware('nest_96_wellplate_100ul_pcr_full_skirt', 'D2', 'Destination Plate')
    
    # Load tip rack
    tiprack = protocol.load_labware('opentrons_flex_96_tiprack_50ul', 'C1')
    
    # Load pipette
    pipette = protocol.load_instrument('flex_1channel_50', mount='right', tip_racks=[tiprack])
    
    # Define liquid
    water = protocol.define_liquid(
        name='Water',
        description='Water for transfer',
